                ...
                },
                {
                    ...
                    formatter : function (value,row) {
                        ...
                        for(var i=0;i<value.length;i++){
                            str+='<a title="'+value[i].building+' '+value[i].floor+' '+value[i].area+'" href="'+value[i].img+'" style="float:left;width:100px;height:80px;overflow:hidden;margin: 1px"><img style="width: 100px;" src="'+value[i].img+'"/></a>';
                        }
                        return str;
                    }
