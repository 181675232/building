...
class ProductModel extends RelationModel {
    ...
    public function getDetails($id) {
        $map['id'] = $id;
        $object = $this->relation('Extend')->field('id,sn,name,type,
                                                    pro_price,sell_price,unit,
                                                    inventory,inventory_in,inventory_out,inventory_alarm,
                                                    create_time')->where($map)->find();
