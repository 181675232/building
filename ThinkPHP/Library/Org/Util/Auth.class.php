...
class Auth{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP' => 't_level', //用户组数据表名
        'AUTH_GROUP_ACCESS' => 't_role_user', //用户组明细表
        'AUTH_RULE' => 't_rule', //权限规则表
        'AUTH_USER' => 't_admin'//用户信息表
    );
    ...
    public function check($name, $uid, $relation='or') {
        ...
        /*------使用单个规则-------*/
        //所有权限判定
        $arr = M()->table($this->_config['AUTH_RULE'])->getField('name',true);
